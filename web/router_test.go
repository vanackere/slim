...
func TestHandlerTypes(t *testing.T) {
	...
	m.Get("/c", func(c context.Context, w http.ResponseWriter, r *http.Request) {
		ch <- "web fn"
	})
	m.Get("/d", HandlerFunc(func(c context.Context, w http.ResponseWriter, r *http.Request) {
		ch <- "web handler"
	}))
...
func TestValidMethods(t *testing.T) {
	...
	m.NotFound(func(c context.Context, w http.ResponseWriter, r *http.Request) {
